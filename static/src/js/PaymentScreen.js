odoo.define('pos_transact.PaymentScreen', function(require) {
    "use strict";
    ...
    const PosTransactPaymentScreen = PaymentScreen => class extends PaymentScreen {
        setup() {
        super.setup();
            onMounted(() => {
                const pendingPaymentLine = this.currentOrder.paymentlines.find(
                    paymentLine => paymentLine.payment_method.use_payment_terminal === 'transact' &&
    ...
    Registries.Component.extend(PaymentScreen, PosTransactPaymentScreen);
